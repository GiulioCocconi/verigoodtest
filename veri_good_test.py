...
def goodbye(exit_status, close = None):
    ...
    if exit_status == 0:
        print(f"Hope you've had fun using this program!")

    print(f"If you've found any bug please open an issue on the project's github page :-)")
...
class Generator(object):
    ...
    def print_head(self):
        ...
        self.print_line("// This file was autogenerated by verigoodtest, if you find any bug please open an issue on github", "head comment")
